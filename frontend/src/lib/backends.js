...
export function saveSettings(settings) {
  localStorage.setItem('coordexa.frontend.settings', JSON.stringify(settings))
}
...
function readSettings() {
  try {
    return JSON.parse(localStorage.getItem('coordexa.frontend.settings') || '{}')
  } catch {
    return {}
  }
}
...
function runtimeConfig() {
  ...
  return window.__COORDEXA_CONFIG__ || {}
}
